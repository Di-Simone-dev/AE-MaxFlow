# MaxFlow Project — Build & Execution Guide (Windows)

Questo documento contiene gli script Python per la generazione dei grafi e il codice C++ per la compilazione ed esecuzione dell'algoritmo di Max Flow su Windows.
